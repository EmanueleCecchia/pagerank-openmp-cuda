...
nulli --- il formato \textbf{CSR} (Compressed Sparse Row) della
Sezione~\ref{sec:csr}. Restano comunque $M$ archi da percorrere a ogni
iterazione, e le iterazioni si susseguono fino a convergenza: questo rende necessario distribuire il calcolo su più unità di
elaborazione.
