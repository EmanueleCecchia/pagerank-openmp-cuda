...
sono nulle: è questa mancanza a richiedere il termine correttivo.

\paragraph{Perché non si costruisce una matrice esplicita.}
Assorbire i due termini correttivi in un'unica matrice è possibile, ma la
renderebbe densa: $N^2$ non nulli --- $5{,}6$~TB per \texttt{web-Google}. Si usa
...
una moltiplicazione matrice-sparsa per vettore (SpMV, Sparse Matrix-Vector
Multiplication): è questa l'operazione che il progetto parallelizza.
