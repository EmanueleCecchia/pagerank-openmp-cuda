...
Il caricatore in \texttt{src/csr.c} verifica cinque proprietà prima di
restituire il grafo, con altrettante funzioni dal nome esplicito:
\begin{itemize}\itemsep2pt
  ...
  \item \texttt{check\_header\_size} --- il file misura esattamente quanto
    l'intestazione implica, controllo fatto prima di qualunque
    allocazione;
