...
CSR, che vedremo nella Sezione~\ref{sec:csr}. 
...
Il formato \textbf{CSR} (Compressed Sparse Row), 
per salvare i valori non nulli della matrice \textbf{MT}, invece di utilizzare 
una matrice bidimensionale $N \times N$ usa tre array monodimensionali:
\begin{itemize}
