...
Gli accumulatori, che nel codice si chiamano \texttt{accum\_t}, restano però
sempre in \texttt{double}: memorizzare milioni di rank in singola precisione
dimezza il traffico di memoria, ma \emph{sommarli} in singola precisione
perderebbe molta più accuratezza di quanta se ne guadagni.
